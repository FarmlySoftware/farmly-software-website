        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Farmly pioneers the future of business transformation through cutting-edge AI, 
              IoT, and intelligent automation. We architect tomorrow's solutions with innovation 
              at our core, empowering industries across Automotive, E-Commerce, Media, Telecom, 
              Logistics, and EV Charging to leap into the digital future.
            </p>
            
            <p className="text-muted-foreground leading-relaxed">
              From AI-driven intelligence to next-generation cloud infrastructure, we're not just 
              building software—we're engineering the future. Our solutions blend cutting-edge 
              innovation with practical implementation, transforming complex challenges into 
              competitive advantages through end-to-end consulting, development, and operations.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
                <span className="text-sm text-muted-foreground">E-Commerce Consulting</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
